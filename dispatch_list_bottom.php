        ...
        <table class="table table-striped" id="data-table">
            ...
            <tbody id="table-body">
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    echo "<tr>";
                    echo "<td>" . htmlspecialchars($row['shipment_id']) . "</td>";
                    echo "<td>" . date("d-m-Y", strtotime($row['date'])) . "</td>";
                    echo "<td>" . htmlspecialchars($row['origin']) . "</td>";
                    echo "<td>" . htmlspecialchars($row['destination']) . "</td>";
                    echo "<td>" . htmlspecialchars($row['receipt_no']) . "</td>";
                    echo "<td class='bg-warning text-black text-center'><span style='color:;font-weight:bold'>DISPATCHED</span></td>";
                    echo "<td>" . htmlspecialchars($row['shipper_name']) . "</td>";
                    echo "<td>" . htmlspecialchars($row['shipper_contact']) . "</td>";
                    echo "<td>" . htmlspecialchars($row['consignee_name']) . "</td>";
                    echo "<td>" . htmlspecialchars($row['consignee_contact']) . "</td>";
                    echo "<td>" . htmlspecialchars($row['weight']) . "</td>";
                    echo "<td>" . htmlspecialchars($row['pieces']) . "</td>";
                    echo "<td>" . htmlspecialchars($row['rate']) . "</td>";
                    echo "<td>" . htmlspecialchars($row['local_charges']) . "</td>";
